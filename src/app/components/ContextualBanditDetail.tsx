    ...
    <>
      ...
      {!banditRef ? null : !definition ? (
        ...
        <Text as="div" size="2" color="gray" mb="3">
          This user was not bucketed into the experiment, so no bandit weights
          were applied.
        </Text>
      ) : (
        <>
          ...
          {isForced ? (
            <Text as="div" size="2" color="amber" mb="3">
              A forced variation is active, so these weights are overridden and
              not what the bandit would serve.
            </Text>
          ) : null}
