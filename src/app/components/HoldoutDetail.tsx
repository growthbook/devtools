...
export default function HoldoutDetail({
  selectedEid,
  setSelectedEid,
  selectedExperiment,
  open,
  ...
  const [currentTab, setCurrentTab] = useTabState("currentTab", "holdouts");
      ...
      <div className="featureDetail" key={`selected_${selectedEid}`}>
        <div className="header">
          {selectedEid && (
            <>
              ...
              <Link
                size="2"
                href={`${appOrigin}/holdout/lookup/?trackingKey=${selectedEid}`}
                target="_blank"
              >
                GrowthBook
                <PiArrowSquareOut
        ...
        <div className="content">
          {selectedExperiment?.experiment?.isDraft ? (
            ...
            >
              <Tooltip content="You are previewing a draft state of this Holdout. Reload the current page to reset.">
          ...
          <div className="my-1">
            <div className="mt-2 mb-3">
              <div className="label font-semibold">Holdout Status</div>
              {selectedExperiment?.evaluatedExperiment?.result?.inExperiment ? (
                <div className="text-green-700 dark:text-green-500 font-semibold text-sm">
                  {selectedExperiment?.evaluatedExperiment?.result?.variationId === 0 ? "In holdout" : "Not in holdout"}
                </div>
              ) : (
